...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_image = n.subscribe("/plvins_feature_tracker/feature", 2000, feature_callback);
    ros::Subscriber sub_linefeature = n.subscribe("/plvins_linefeature_tracker/linefeature", 2000, linefeature_callback);
